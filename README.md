...
### 👋 Hi, I'm Arpan — a Full-Stack Developer from Bangladesh, building for the web.

I've spent the last couple of years turning ideas into working products — from designing the database schema to shipping the final UI. My focus isn't just making things look right; it's making sure the logic underneath actually holds up under real usage.

I enjoy working on the hard parts: role-based access, conflict detection, server-enforced business rules, and APIs that don't break when someone uses them the wrong way. I work primarily in the JavaScript/TypeScript ecosystem, and I'm most comfortable in environments where I can own a feature end-to-end — from how data is stored to how it's presented.
...
### 🎓 [LearnHub](https://github.com/Arpan-Dey-Web/learnhub-client) — Learning Platform · [Live Demo](#)
...
### 🐾 [PawHome](https://github.com/Arpan-Dey-Web/pawhome-client) — Pet Adoption Platform · [Live Demo](#)
...
### 🍽️ [EpiqDine](https://github.com/Arpan-Dey-Web/epiqdine-client) — Restaurant Management System · [Live Demo](#)
